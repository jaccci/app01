library(shiny)
runGitHub(repo="app01", username="jacci", ref="main")
library(shinythemes)
library(tidyverse)
library(ggplot2)
library(ggrepel)
...
library(rmarkdown)
render("RMD02.Rmd", output_format = "word_document")
#for(i in c(1:57))
#devtools::install_github('jbkunst/highcharter')
#devtools::install_github('dreamRs/billboarder')
src = "D:\\招生分析\\招生戰情室2_7\\final3.csv"
#全校分析作圖
...
傳播學院系 <- c("請選擇系所","影像傳播學系", "新聞傳播學系", "廣告傳播學系")
外國語文學院系 <- c("請選擇系所","英國語文學系", "德語語文學系", "法國語文學系", "西班牙語文學系", "日本語文學系", "義大利語文學系")
教育學院系 <- c("請選擇系所","體育學系體育學組", "體育學系運動競技組", "體育學系運動健康管理組","圖書資訊學系", "教育領導與科技發展學士學位學程")
文學院系 <- c("請選擇系所","中國文學系", "歷史學系", "哲學系")
民生學院系 <- c("請選擇系所","兒童與家庭學系", "餐旅管理學系", "食品科學系", "營養科學系")
法律學院系 <- c("請選擇系所","法律學系", "財經法律學系", "學士後法律學系")
理工學院系 <- c("請選擇系所","數學系應用數學組", "數學系資訊數學組","物理學系光電物理組", "物理學系物理組","化學系", "生命科學系", "資訊工程學系", "電機工程學系", "醫學資訊與創新應用學士學位學程", "人工智慧與資訊安全學士學位學程")
社會科學院系 <- c("請選擇系所","社會學系", "社會工作學系", "經濟學系", "宗教學系", "心理學系", "天主教研修學士學位學程")
管理學院系 <- c("請選擇系所","企業管理學系", "會計學系", "統計資訊學系", "金融與國際企業學系", "資訊管理學系")
...
# Define UI ----
# navbarPage<-a top level navigation bar that can be used to toggle a set of tabPanel elements
ui <- navbarPage(
  "各系110年度三大入學管道學業表現",
